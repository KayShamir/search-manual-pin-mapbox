...
export default function MapWithGeocoder() {
  ...
  return (
    <div className="relative w-full h-full min-h-screen">
      <div className="absolute top-6 left-6 z-10 flex flex-col items-start space-y-2">
        <SearchBox
        ...
        />
        {selectedLocation && (
          <div className="bg-white/90 rounded px-3 py-1 mt-2 text-sm shadow text-gray-800">
            <b>Coordinates:</b> {selectedLocation.lat.toFixed(6)}, {selectedLocation.lng.toFixed(6)}
          </div>
        )}
      </div>
      <div
